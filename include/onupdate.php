 ...
 */
function xoops_module_pre_update_tellafriend(XoopsModule $module)
{
...
function xoops_module_update_tellafriend(XoopsModule $module, $previousVersion = null)
{
    $moduleDirName = basename(dirname(__DIR__));
    ...
    /** @var Tellafriend\Helper $helper */
    /** @var Tellafriend\Utility $utility */
    /** @var Tellafriend\Configurator $configurator */
    $helper  = Tellafriend\Helper::getInstance();
    $utility = new Tellafriend\Utility();
    $configurator = new Tellafriend\Configurator();

    if ($previousVersion < 240) {

        //rename column EXAMPLE
        $tables     = new Tables();
        $table      = 'tellafriendx_categories';
        $column     = 'ordre';
        $newName    = 'order';
